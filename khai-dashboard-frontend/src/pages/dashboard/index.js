...
import { AnalyticsAppTypes, AnalyticsSocialSources } from '../../sections/dashboard/analytics/analytics-social-sources';
...
import { AnalyticsTableLoading } from '../../sections/dashboard/analytics/analytics-table-loading';
      ...
      >
        <Container maxWidth={settings.stretch ? false : 'xl'}>
          ...
          >
            ...
            <Grid xs={12} lg={8}>
              {loadingApplication ? <AnalyticsTableLoading /> : <ApplicationsList applications={applications.list} />}
            </Grid>
            <Grid xs={12} lg={4}>
              {/* <AnalyticsSocialSources chartSeries={[10, 10, 20]} labels={['Linkedin', 'Facebook', 'Instagram']} /> */}
              {loadingApplication ? <></> : <AnalyticsAppTypes applications={applications.groupped} />}
            </Grid>
          </Grid>
        </Container>
      </Box>
